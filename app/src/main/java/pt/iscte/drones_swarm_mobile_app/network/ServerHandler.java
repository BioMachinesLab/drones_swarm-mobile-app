...
public final class ServerHandler implements Runnable {
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                Log.i("SH-EXCEPTION"+e.getClass().getName(), e.getMessage());
                            }
                        }
                    }).start();
    ...
    private void setLeftMenuValues(final DronesInformationResponse message) {
        // Set Left Menu
        context.runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    public void addListenerOnSpinnerItemSelectionLeft_menu_drone(DronesInformationResponse message) {
        final Spinner spinner_configure = (Spinner) context.findViewById(R.id.spinner_left_menu_drone);
